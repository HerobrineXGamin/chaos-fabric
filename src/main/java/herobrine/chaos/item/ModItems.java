...
import herobrine.chaos.item.custom.Maledictum;
...
public class ModItems {
    public static final Item FATES_INFLUENCE = registerItem("fates_influence",
            new FatesInfluence(ToolMaterials.NETHERITE, 5, -2.4f, new FabricItemSettings().group(ItemGroup.COMBAT).fireproof()));
    ...
    public static final Item MALEDICTUM = registerItem("maledictum",
            new Maledictum(new FabricItemSettings().group(ItemGroup.COMBAT).fireproof()));
